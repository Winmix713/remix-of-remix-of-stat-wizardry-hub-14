  ...
  if (loading) {
    return (
      <section className="space-y-6 winmix-fade-in">
        ...
        <div className="grid-auto relative z-10">
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className="winmix-stat-card rounded-xl p-fluid-md animate-pulse"
            >
      ...
      <div className="grid-auto relative z-10">
        {statsConfig.map((stat, index) => {
          ...
          return (
            <div
              key={stat.title}
              className={`winmix-stat-card relative rounded-xl p-fluid-md group ${getHoverClass()} winmix-slide-up`}
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-fluid-3xl font-bold text-foreground group-hover:text-white transition-colors stat-number">
                    <NumberCounter 
                      value={stat.value} 
                      duration={1500} 
